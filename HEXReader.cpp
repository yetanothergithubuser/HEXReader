...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Reads std::string at specified position (32 char long)
///
/// 
///
/// @param offset Offset from current Position (depends on bRelativeToCurrentPos)
/// @param bRelativeToCurrentPos Determines how Offset is interpreted (relative from current Position, or absolute from beginning of File)
/// @return A std::string at the specified position or "NULLLOL" if something went wrong
/// @sa ReadByteArray()
/// @attention Allocated buffer gets also freed here
/// @todo replace "NULLLOL" return on failure or add log ability and/or assertion
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//HEXREADER_API std::string HEX::HEXReader::ReadString(const std::streamoff offset /*= 0x0*/, bool bRelativeToCurrentPos /*= true*/)
//{
//	void* buffer = NULL;
//	buffer = ReadByteArray(sizeof(char) * 32, offset, bRelativeToCurrentPos);
//	if (buffer == NULL)
//	{
//		delete[] buffer;
//		return std::string("NULLLOL");
//	}
//
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Reads std::string at specified position with custom length
///
/// 
///
...
/// @todo replace "NULLLOL" return on failure or add log ability and/or assertion
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//HEXREADER_API std::string HEX::HEXReader::ReadString(size_t size, const std::streamoff offset /*= 0x0*/, bool bRelativeToCurrentPos /*= true*/)
//{
//	void* buffer = NULL;
...
//	std::string ret;
//	ret.clear();
//	ret = std::string(reinterpret_cast<char*>(buffer), size);
//	delete[] buffer;
//
//	return ret;
//}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Reads std::wstring at specified position (32 wchar long)
///
///
///
/// @param offset Offset from current Position (depends on bRelativeToCurrentPos)
/// @param bRelativeToCurrentPos Determines how Offset is interpreted (relative from current Position, or absolute from beginning of File)
/// @return A std::wstring at the specified position or L"NULLLOL" if something went wrong
/// @sa ReadByteArray()
/// @attention Allocated buffer gets also freed here
/// @todo replace L"NULLLOL" return on failure or add log ability and/or assertion
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//HEXREADER_API std::wstring HEX::HEXReader::ReadWString(const std::streamoff offset /*= 0x0*/, bool bRelativeToCurrentPos /*= true*/)
//{
//	void* buffer = NULL;
//	buffer = ReadByteArray(sizeof(wchar_t) * 32, offset, bRelativeToCurrentPos);
//	if (buffer == NULL)
//	{
//		delete[] buffer;
//		return std::wstring(L"NULLLOL");
//	}
//	std::wstring ret = reinterpret_cast<wchar_t*>(buffer);
//
//	delete[] buffer;
//
//	return ret;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @brief Reads std::wstring at specified position with custom length
///
///
///
/// @param size length of string to be read
...
/// @todo replace L"NULLLOL" return on failure or add log ability and/or assertion
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//HEXREADER_API std::wstring HEX::HEXReader::ReadWString(size_t size, const std::streamoff offset /*= 0x0*/, bool bRelativeToCurrentPos /*= true*/)
//{
//	void* buffer = NULL;
